app.controller('inboxController', function($scope, $state, $http, $ionicModal, $ionicScrollDelegate, $rootScope, $validateLogin, $messaging, $ionicPopup) {
    $validateLogin();
...
app.factory('$messaging', function($http, $rootScope, ionicToast) {
    var messaging = {};
    messagesSent = [];
    messagesInbox = [];
            ...
            .then(function(res) {
                if (res.status == 200) {
                    ...
                    if (index != -1) {
                        ...
                        ionicToast.show('Message Deleted Successfully.', 'bottom', false, 2500);
                    }
                } else {
                    ionicToast.show('Server Error! Delete failed', 'bottom', false, 2500);
                }
            })
            .catch(function(err) {
                ionicToast.show('Cant reach server', 'bottom', false, 2500);
            });
    }
