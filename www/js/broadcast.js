...
app.controller('broadcastCtrl', function($ionicLoading, $ionicScrollDelegate, $scope, $ionicModal, $timeout, $rootScope, $state, $validateLogin, $firebaseArray, broadService) {
...
app.controller('broadcastViewCtrl', function(broadService, $state, $ionicModal, $timeout, $ionicLoading, $scope, $ionicScrollDelegate, $anchorScroll, $rootScope, $firebaseArray, $location, $window, $validateLogin) {
    $scope.$on('$ionicView.enter', function() {
        console.log("onEnter");
        $validateLogin();
